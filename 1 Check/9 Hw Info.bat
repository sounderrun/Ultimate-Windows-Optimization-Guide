...
$Host.UI.RawUI.WindowTitle = 'Hw Info (Administrator)'
(irm https://github.com/FR33THYFR33THY/Ultimate-Windows-Optimization-Guide/raw/refs/heads/main/1%20Check/9%20Hw%20Info.ps1) -replace '.*WindowTitle.*', '' | iex