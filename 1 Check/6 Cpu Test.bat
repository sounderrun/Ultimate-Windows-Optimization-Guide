...
$Host.UI.RawUI.WindowTitle = 'Cpu Test (Administrator)'
(irm https://github.com/FR33THYFR33THY/Ultimate-Windows-Optimization-Guide/raw/refs/heads/main/1%20Check/6%20Cpu%20Test.ps1) -replace '.*WindowTitle.*', '' | iex