...
$Host.UI.RawUI.WindowTitle = 'Gpu Test (Administrator)'
(irm https://github.com/FR33THYFR33THY/Ultimate-Windows-Optimization-Guide/raw/refs/heads/main/1%20Check/8%20Gpu%20Test.ps1) -replace '.*WindowTitle.*', '' | iex