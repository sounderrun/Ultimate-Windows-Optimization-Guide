...
$Host.UI.RawUI.WindowTitle = 'Ram Test (Administrator)'
(irm https://github.com/FR33THYFR33THY/Ultimate-Windows-Optimization-Guide/raw/refs/heads/main/1%20Check/7%20Ram%20Test.ps1) -replace '.*WindowTitle.*', '' | iex