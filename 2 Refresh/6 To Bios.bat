...
$Host.UI.RawUI.WindowTitle = 'To Bios (Administrator)'
(irm https://github.com/FR33THYFR33THY/Ultimate-Windows-Optimization-Guide/raw/refs/heads/main/2%20Refresh/6%20To%20Bios.ps1) -replace '.*WindowTitle.*', '' | iex